...
const defaultOptions3 = {
	loop: false,
	autoplay: true,
	animationData: footerLoading.default,
	rendererSettings: {
				...
				<div id="footerContent">
					<div id="footerContactBorder">
						{status === 'SUCCESS' ? (
							...
							<form action="https://formspree.io/moqwldol" method="POST" onSubmit={this.submitForm}>
						...
						{status === 'ERROR' && (
							<p>
								Wystąpił błąd. Maila nie wysłano. Zadzwoń, napisz na Messenger, lub napisz na:
								tymekoks@gmail.com
							</p>
						)}
					</div>
