			...
			<div id="aboutMeContainer">
				<div id="aboutMeTextContainer" data-aos="fade-right" data-aos-duration="3000" data-aos-once="true">
					...
					<div id="aboutMeContent">
						Cześć! Jak mogliście zauważyć, jestem pasjonatem sportu. Od ponad 9 lat pogłębiam wiedzę o
						treningach, żywieniu oraz podejściu mentalnym w tych dziedzinach. Od trzech lat pracuje w branży
						jako trener. Przez ten czas współpracowałem z dużą ilością osób i większość z nich osiągnęła
						swoje cele! Powstanie tej strony pozwala mi znacznie zwiększyć doświadczenie. Wiąże się z tym
